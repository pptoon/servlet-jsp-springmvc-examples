...
public class CustomerServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -2106081392210384461L;
	private static final String URL_LIST = "/customer";
	private static final String URL_EDIT = "/editCustomer";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (uri.endsWith(URL_LIST)) {
			sendCustomerList(response);
		} else if (uri.endsWith(URL_EDIT)) {
