...
public class ShoppingCartServlet extends HttpServlet {
	...
	private static final String URL_VIEW_PRODUCTS_DETAILS= "/viewProductDetails";
	private static final String URL_VIEWCART= "viewCart";
	
	

	/** 商品信息：可以理解为一个商城中的所有商品 */
	...
	public void doGet(HttpServletRequest request,
		...
		if (uri.endsWith(URL_PRODUCTS)) {
			sendProductList(response);
		} else if (uri.endsWith(URL_VIEW_PRODUCTS_DETAILS)) {
			sendProductDetails(request, response);
		} else if (uri.endsWith(URL_VIEWCART)) {
	 ...
	 * @param productId
	 *            [产品Id]
	 * @return [满足Id=productId要求的产品信息，没有则返回空对象]
	 */
