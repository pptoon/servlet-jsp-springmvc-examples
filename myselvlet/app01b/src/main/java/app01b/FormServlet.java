...
public class FormServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1868463710250276021L;
	
	private static final String TITLE= "Order Form";
	private static final String CATALOG=  "catalogRequest";
	...
	protected void doGet(HttpServletRequest request,
		...
		writer.println("<td><input name='name' value='fatcat'/></td>");
		writer.println("</tr>");
		writer.println("<tr>");
		writer.println("<td>Address:</td>");
		writer.println("<td><textarea name='address' "
		+ "cols='40' rows='5'>fatcat home</textarea></td>");
		writer.println("</tr>");
		writer.println("<tr>");
		writer.println("<td>Country:</td>");
		writer.println("<td><select name='country'>");
		writer.println("<option selected='selected'>China</option>");
		...
		"name='deliveryMethod'"
		+ " value='First Class' checked/>First Class");
		...
		+ "cols='40' rows='5'>shipping instructions</textarea></td>");
		writer.println("</tr>");
		writer.println("<tr>");
		writer.println("<td>&nbsp;</td>");
		writer.println("<td><textarea name='instruction' "
		+ "cols='40' rows='5'>instruction</textarea></td>");
		writer.println("</tr>");
		writer.println("<tr>");
		writer.println("<td>Please send me the latest " +
		"product catalog:</td>");
		writer.println("<td><input type='checkbox' " +
		"name='catalogRequest' checked='checked'/></td>");
		writer.println("</tr>");
		writer.println("<tr>");
		writer.println("<td>&nbsp;</td>");
